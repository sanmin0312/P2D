...
def main():
    mini_trainval_nusc = NuScenes(version='v1.0-trainval',
                             dataroot='./data/nuScenes/',
                             verbose=True)
    mini_train_scenes = ['scene-0001']
    mini_val_scenes = ['scene-0001']
    ...
    mmcv.dump(mini_train_infos, './data/nuScenes/nuscenes_infos_mini_train.pkl')
    mmcv.dump(mini_val_infos, './data/nuScenes/nuscenes_infos_mini_val.pkl')
    ...
    trainval_infos = generate_info(trainval_nusc, trainval_scenes)
    mmcv.dump(trainval_infos, './data/nuScenes/nuscenes_infos_trainval.pkl')
    #
