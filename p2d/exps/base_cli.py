...
from p2d.callbacks.ema import EMACallback
from p2d.utils.torch_dist import all_gather_object, synchronize

from .nuscenes.base_exp import P2DLightningModel


def run_cli(model_class=P2DLightningModel,
            exp_name='base_exp',
            use_ema=False):
    ...
    parser = P2DLightningModel.add_model_specific_args(parent_parser)
