...
from p2d.datasets.nusc_det_dataset import NuscDetDataset, collate_fn
from p2d.evaluators.det_evaluators import DetNuscEvaluator
from p2d.utils.torch_dist import all_gather_object, get_rank, synchronize
...
class P2DLightningModel(LightningModule):
